...
export function CreateMemeFormSkeleton() {
  return (
    <div
      className="create-meme-form grid gap-3 pb-[calc(5.25rem+env(safe-area-inset-bottom,0px))] md:gap-4 md:pb-0 xl:grid-cols-[minmax(0,1fr)_minmax(280px,360px)] xl:items-start"
      aria-busy="true"
