...
import { AppMobileMenu, AppMobileMenuButton } from "@/components/layout/AppMobileMenu";
...
export function AppHeaderView({ pathname }: { pathname: string }) {
  ...
  return (
    <>
      <header className="app-header">
        <div className={`app-header-inner ${shellHeaderInnerClass}`}>
          ...
          <div className="app-header-actions">
            ...
            <AppMobileMenuButton open={menuOpen} onClick={() => setMenuOpen((open) => !open)} />
      ...
      <AppMobileMenu open={menuOpen} onClose={() => setMenuOpen(false)} pathname={pathname} />
    </>
  );
}
